...
//   const DropDownSearchTest({super.key});

//   @override
//   // ignore: library_private_types_in_public_api
//   _DropDownSearchTestState createState() => _DropDownSearchTestState();
// }
...
//                 children: [
//                   Expanded(
//                     child: DropdownSearch<SizeModel>(
//                       asyncItems: (filter) => getData(filter),
//                       compareFn: (i, s) => i.id.toString() == s.id.toString(),
//                       popupProps: PopupPropsMultiSelection.modalBottomSheet(
//                         isFilterOnline: true,
...
//                   const Padding(padding: EdgeInsets.all(4)),
//                   Expanded(
//                     child: DropdownSearch<SizeModel>.multiSelection(
//                       selectedItems: const [],
//                       asyncItems: (filter) => getData(filter),
//                       compareFn: (i, s) => i.id.toString() == s.id.toString(),
//                       popupProps: PopupPropsMultiSelection.modalBottomSheet(
...
//               DropdownSearch<MultiLevelString>.multiSelection(
//                 key: myKey,
//                 items: myItems,
//                 compareFn: (i1, i2) => i1.level1 == i2.level1,
//                 popupProps: PopupPropsMultiSelection.modalBottomSheet(
...
//       BuildContext context, List<SizeModel> selectedItems) {
...
//   Future<List<SizeModel>> getData(filter) async {
...
//     // if (data != null) {
//     //   return SizeModel.fromJsonList(data);
//     // }
//     return Future(() => getAllSizesFromShared());
//     // return [];
//   }
// }
